...
# PureCore-compatible UAC2 Audio Gadget
...
# Device Descriptor (PureCore clone)
...
# Playback ONLY (PureCore has no capture)
...
echo "PureCore USB Audio" > functions/uac2.0/function_name

# Configuration (self-powered, 100mA like PureCore)
mkdir -p configs/c.1
...
echo "PureCore clone UAC2 configured on $UDC_DEV"
